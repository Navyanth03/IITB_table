...
function populateTable(index) {
    ...
    chemicals.forEach((chemical,index) => {
        ...
        row.innerHTML = `
            <td>
                <svg id="mySvg-${chemical.id}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6" onclick="changeColor(${chemical.id})">
